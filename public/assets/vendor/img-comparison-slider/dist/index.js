                    ...
                    return (
                        ...
                        (e.i = function (t, i, s) {
                            ...
                            for (var a = 0; a < t.length; a++) {
                                var l = [].concat(t[a]);
                                (s && o[l[0]]) || (i && (l[2] ? (l[2] = "".concat(i, " and ").concat(l[2])) : (l[2] = i)), e.push(l));
                            }
                        }),
                        e
                    );
                ...
                connectedCallback() {
                    this.hasAttribute("tabindex") || (this.tabIndex = 0),
                        ...
                        this.querySelectorAll('[slot="before"], [slot="after"]').length > 0 &&
                            console.warn('<img-comparison-slider>: slot names "before" and "after" are deprecated and soon won\'t be supported. Please use slot="first" instead of slot="after", and slot="second" instead of slot="before".');
                }
