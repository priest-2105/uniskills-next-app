...
<Head>
            ...
            <style
                    dangerouslySetInnerHTML={{
                        ...
                        @keyframes draw {
                        from {
                            stroke-dashoffset:4000; /* Adjust this value to match the length of your path */
                        }
                        to {
                            stroke-dashoffset: 0;
                        }
                        ...
                        stroke-width: 2;
                        fill: none;
                        stroke-dasharray: 1000; /* Adjust this value to match the length of your path */
                        stroke-dashoffset:1000; /* Start with the full length of the path */
                        animation: draw 5s infinite; /* Adjust time as needed */
                        }
                        ...
                        @media only screen and (min-width:768px) {
                            ...
                            .preloader-text {
                                font-size:100px;
                                animation: pop 2s infinite ease-in-out; /* Adjust time as needed */
                            }
      ...
      <h1 className="display-3 text-center preloader-text mx-auto pt-5 my-2 my-sm-4" style={{ marginTop:"20vh", maxWidth: "680px"}}><br/> <b className="uni-text text-primary ms-3">Uni</b> Skills</h1>
      <svg className="draw-path d-block mx-auto text-primary" width="511" height="40" viewBox="0 0 511 40" fill="currentcolor" xmlns="http://www.w3.org/2000/svg">
