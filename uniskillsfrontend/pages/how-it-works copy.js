...
export default function HowItks() {
    ...
    <Layout initials={page_initials}>
      ...
      <Head>
        ...
        <div className="bg-secondary">
            ...
            <p class="leading-1 px-5">Youve got a million things on your to-do list for your project. You have to delegate tasks, schedule meetings and track progress. You only need UniSkills to manage your project. We`ll help you get things done with its simple and intuitive interface.</p>
            </div>
   {/* d Item--> */}
            <div
