...
export default function Home({ data }) {
	...
	const page_initials = {
		page_title: "Home | " + config.APP_NAME,
		body_class: "page-wrapper",
	};
	...
	return (
		...
		<Layout initials={page_initials}>
			<section
				className="bg-secondary py-5 hero"
				data-aos="fade-up"
			...
			>
				<div
					className="container text-center pt-4 mt-lg-2 mt-xl-3 hero"
					style={{
						maxHeight: "2800px",
						backgroundImage:
							"url('/assets/img/landing/web-studio/hero-wave.png')",
				...
				>
					...
					>
						<h1 className="display-4 position-relative zindex-2 mb-0">
							Find and Hire the Best Students
						</h1>
					...
					<Link
						className="btn btn-lg btn-primary me-1 mt-4"
						href={`/${config.ABOUT}`}
					>
						Learn More
					</Link>
					<Link
						className="btn btn-lg btn-primary ms-1 mt-4"
						href={`/${config.LOGIN}`}
					>
						Get Started
					</Link>
				...
				>
					<iframe
						title="vimeo-player"
						src="https://player.vimeo.com/video/708322704?h=5314f3a3a7"
						width="100%"
						height="100%"
						frameborder="0"
						allowfullscreen
			...
			<section
				className="container py-5 mt-2 mt-sm-3 mt-md-4 d-xs-flex-row-reverse d-xs-flex-row-reverse d-sm-flex-row-reverse"
				style={{ overflow: "hidden" }}
			>
				<h2 className="h1 text-center pt-lg-3">
					What`s New ? In
					<span className="text-primary"> Uniskills v3</span>
					<span className="badge bg-faded-success text-danger mb-3 p-2 fs-sm">
						{" "}
					</span>
				</h2>
				<p className="pb-3 pb-md-4 mb-0 mb-sm-2 mb-lg-3 text-center">
					Transformative Features for Students and Businesses Alike
				</p>
				<div className="row align-items-lg-center">
						...
						<div className="ps-lg-4 ps-xl-0">
							<div className="binded-content">
								<div className="binded-item active" id="finance-img">
									<Image
										className="rounded-5"
										src="/assets/img/landing/a-hand-holding-a-phone-in-a-sunny-room-typing-a-me-upscaled.png"
										width={525}
										height={100}
										alt="Image"
									/>
								...
								<div className="binded-item" id="tech-img">
									<Image
										className="rounded-5"
										src="/assets/img/landing/ai-technology-microchip-background-digital-transformation-concept.jpg"
										width={525}
										height={100}
										alt="Image"
									/>
								...
								<div className="binded-item" id="medicine-img">
									<Image
										className="rounded-5"
										src="/assets/img/landing/_apowerfulsea.png"
										width={525}
										height={100}
										alt="Image"
									/>
								...
								<div className="binded-item" id="ecommerce-img">
									<Image
										className="rounded-5"
										src="/assets/img/landing/14979112_SL_052021_43150_03.jpg"
										width={525}
										height={100}
										alt="Image"
									/>
					...
					<div
						className="col-md-6 col-lg-5 pb-2 pb-lg-0 mb-4 mb-md-0"
						data-aos="fade-left"
						data-aos-duration="500"
						data-aos-offset="250"
						data-disable-parallax-down="md"
						...
						<div className="accordion accordion-alt" id="industries">
							<div className="accordion-item mb-2 mb-lg-2 mb-xl-1">
								<h3 className="accordion-header text-lg text-md text-sm">
									<button
										className="accordion-button fs-4 text-lg text-md text-sm "
										type="button"
								...
								>
									<div className="accordion-body">
										UniSkills v3 is proud to unveil its next-level chat
										experience, featuring an enhanced UI and unprecedented
										speed. Our commitment to performance means students and
										businesses can enjoy a fluid and responsive communication
										platform. Embrace the future of collaboration with UniSkills
										v3, where chat performance knows no bounds
									</div>
								</div>
							</div>
							<div className="accordion-item mb-2 mb-lg-2 mb-xl-1">
								<h3 className="accordion-header text-lg text-md text-sm">
									<button
										className="accordion-button fs-4 text-lg text-md text-sm  collapsed"
										type="button"
										data-bs-toggle="collapse"
										data-binded-content="#tech-img"
										data-bs-target="#tech"
										aria-expanded="false"
										aria-controls="tech"
									>
								...
								>
									<div className="accordion-body">
										UniSkills v3 introduces your personalized career concierge,
										leveraging AI assistance for bio and job postings. Tailor
										your professional narrative with ease and let our
										intelligent system enhance your job listings for maximum
										impact. Navigate your career journey with precision, powered
										by UniSkills v3`s cutting-edge AI guidance.
									</div>
								</div>
							</div>
							<div className="accordion-item mb-2 mb-lg-2 mb-xl-1">
								<h3 className="accordion-header text-lg text-md text-sm">
									<button
										...
										type="button"
										data-bs-toggle="collapse"
										data-binded-content="#medicine-img"
								...
								>
									<div className="accordion-body">
										Discover a new era of efficiency with UniSkills advanced
										filters, designed to simplify your search for business
										collaborations and job opportunities. Tailor your
										preferences effortlessly, whether you`re seeking the perfect
										project or the ideal candidate. UniSkills ensures that
										finding the right match is not just easy but tailored
							...
							<div className="accordion-item mb-2 mb-lg-2 mb-xl-1">
								<h3 className="accordion-header text-lg text-md text-sm">
									<button
										...
										type="button"
										data-bs-toggle="collapse"
										data-binded-content="#ecommerce-img"
								...
								>
									<div className="accordion-body">
										UniSkills is committed to constant improvement, and we value
										your insights. Introducing our update suggestion feature,
										where your ideas have the potential to drive meaningful
										evolution. Whether it`s refining existing features or
										proposing new ones, your contributions play a crucial role
										in ensuring UniSkills remains at the forefront of
										innovation. Let`s build a better future together!
									</div>
								</div>
							</div>
						</div>
						<Link
							className="btn mt-3 btn-primary col-12"
			...
			<section className="overflow-hidden py-5 mt-md-3 mt-lg-2 mt-xl-4 mt-xxl-5">
				<div className="container pt-2 pt-sm-4 pt-lg-5">
					<h2 className="h1 text-center pb-3 mb-3 mb-lg-4">
						How does <span className="text-primary">Uniskills</span> work?{" "}
					</h2>
					<ul
						className="nav nav-tabs text-center ms-auto me-auto justify-content-center"
						role="tablist"
					>
					...
					<div className="tab-content">
						...
						>
							<div className="row align-items-center mb-3 position-relative pb-2 pb-lg-0 mb-1 mb-sm-1 mb-md-2 mb-lg-0">
								<div
									className="col-md-6  col-xl-5 offset-lg-1 order-md-2 pb-1 pb-md-0 mb-1 mb-md-0"
									data-aos="fade-left"
									data-aos-duration="500"
									data-aos-offset="250"
									data-disable-parallax-down="md"
								>
									<Image
										...
										src="/assets/img/landing/saas-2/steps/Mobile-login-bro.png"
										width={525}
										height={100}
										alt="Image"
									/>
								...
								<div
									className="col-md-6 col-lg-5  bg-secondary pt-3 pb-3 pe-3 ps-3 rounded col-xl-4 offset-xl-1 order-md-1"
									data-aos="fade-right"
									data-aos-duration="500"
									data-aos-offset="250"
									data-disable-parallax-down="md"
								>
									<div className="pe-md-4 pe-lg-0">
										<span className="badge fs-sm bg-faded-primary text-primary mb-3 mb-lg-4">
											Step 01
										</span>
										...
										<ul className="list-unstyled mb-0">
											<li className="d-flex pt-1 mt-2">
												...
												Pick Your Role: Student/Business
											</li>
											<li className="d-flex pt-1 mt-2">
												<i className="ai-check-alt text-primary fs-4 mt-n1 me-2"></i>
												Provide Info: Name, Email
											</li>
											<li className="d-flex pt-1 mt-2">
												<i className="ai-check-alt text-primary fs-4 mt-n1 me-2"></i>
							...
							<div className="row align-items-center mb-3 position-relative pb-1 pb-lg-0 mb-1 mb-sm-2 mb-md-2 mb-lg-0">
								<div
									className="col-md-6 col-xl-5 offset-xl-1 pb-1 pb-md-0 mb-2 mb-md-0"
									data-aos="fade-right"
									data-aos-duration="500"
									data-aos-offset="250"
									data-disable-parallax-down="md"
								>
									<Image
										className="d-dark-mode-none"
										src="/assets/img/landing/saas-2/steps/Creativity-pana.png"
										width={373}
										height={100}
										alt="Image"
									/>
								...
								<div
									className="col-md-6 col-lg-5  bg-secondary pt-3 pb-3 pe-3 ps-3 rounded col-xl-4 offset-lg-1"
									data-aos="fade-left"
									data-aos-duration="500"
									data-aos-offset="250"
									data-disable-parallax-down="md"
							...
							<div className="row align-items-center mb-3 position-relative">
								...
								>
									<Image
										className="d-dark-mode-none"
										src="/assets/img/landing/saas-2/steps/Business-support-amico.png"
										width={373}
										height={100}
										alt="Image"
									/>
								...
								<div
									className="col-md-6 col-lg-5 col-xl-4 bg-secondary pt-3 pb-3 pe-3 ps-3 rounded offset-xl-1 order-md-1"
									data-aos="fade-right"
									data-aos-duration="500"
									data-aos-offset="250"
									data-disable-parallax-down="md"
								>
									<div className="pe-md-4 pe-lg-0">
										...
										<ul className="list-unstyled mb-0">
											<li className="d-flex pt-1 mt-2">
												<i className="ai-check-alt text-primary fs-4 mt-n1 me-2"></i>
												Browse Jobs/Profiles
											</li>
											<li className="d-flex pt-1 mt-2">
												<i className="ai-check-alt text-primary fs-4 mt-n1 me-2"></i>
												Apply for Post Impactful Jobs
											</li>
											<li className="d-flex pt-1 mt-2">
												<i className="ai-check-alt text-primary fs-4 mt-n1 me-2"></i>
						...
						<div className="tab-pane fade" id="business" role="tabpanel">
							<div className="row align-items-center mb-3 position-relative pb-2 pb-lg-0 mb-1 mb-sm-2 mb-md-2 mb-lg-0">
								<div
									className="col-md-6 col-xl-5 offset-lg-1 order-md-2 pb-1 pb-md-0 mb-2 mb-md-0"
									data-aos="fade-left"
									data-aos-duration="500"
									data-aos-offset="250"
									data-disable-parallax-down="md"
								>
									<Image
										className="d-dark-mode-none"
										src="/assets/img/landing/saas-2/steps/Login-pana.png"
										width={525}
										height={100}
										alt="Image"
									/>
								...
								<div
									className="col-md-6 col-lg-5 col-xl-4 offset-xl-1 order-md-1  bg-secondary pt-3 pb-3 pe-3 ps-3 rounded"
									data-aos="fade-right"
									data-aos-duration="500"
									data-aos-offset="250"
									data-disable-parallax-down="md"
								>
									<div className="pe-md-4 pe-lg-0">
										...
										<h3 className="h2 mb-3 mb-lg-4">
											Sign Up & Register Your Business
										</h3>
										<ul className="list-unstyled mb-0">
											<li className="d-flex pt-1 mt-2">
												<i className="ai-check-alt text-primary fs-4 mt-n1 me-2"></i>
												Publish a Unique Business Name
											</li>
											<li className="d-flex pt-1 mt-2">
												<i className="ai-check-alt text-primary fs-4 mt-n1 me-2"></i>
												Provide Info: Name, Email, etc
											</li>
											<li className="d-flex pt-1 mt-2">
												<i className="ai-check-alt text-primary fs-4 mt-n1 me-2"></i>
												Confirm Email: Click Link
							...
							<div className="row align-items-center mb-3 position-relative pb-2 pb-lg-0 mb-1 mb-sm-1 mb-md-2 mb-lg-0">
								...
								>
									<Image
										className="d-dark-mode-none"
										src="/assets/img/landing/saas-2/steps/Online--page-rafiki.png"
										width={373}
										height={100}
										alt="Image"
									/>
								...
								<div
									className="col-md-6 col-lg-5 col-xl-4 offset-lg-1  bg-secondary pt-3 pb-3 pe-3 ps-3 rounded"
									data-aos="fade-left"
									data-aos-duration="500"
									data-aos-offset="250"
									data-disable-parallax-down="md"
								>
									<div className="ps-md-4 ps-lg-0">
										...
										<ul className="list-unstyled mb-0">
											...
											<li className="d-flex pt-1 mt-2">
												<i className="ai-check-alt text-primary fs-4 mt-n1 me-2"></i>
												Upload Business Banner and others
											</li>
										</ul>
									</div>
								</div>
							...
							<div className="row align-items-center mb-3 position-relative">
								...
								>
									<Image
										className="d-dark-mode-none"
										src="/assets/img/landing/saas-2/steps/New--employee-rafiki.png"
										width={373}
										height={100}
										alt="Image"
									/>
								...
								>
									<div className="pe-md-4 pe-lg-0">
										...
										<ul className="list-unstyled mb-0">
											...
											<li className="d-flex pt-1 mt-2">
												<i className="ai-check-alt text-primary fs-4 mt-n1 me-2"></i>
												Post Impactful Jobs and Neccesary Skills Required
											</li>
											<li className="d-flex pt-1 mt-2">
												<i className="ai-check-alt text-primary fs-4 mt-n1 me-2"></i>
												Connect, Collaborate, Succeed
			...
			<section className="d-flex w-100 position-relative bg-transparent overflow-hidden">
				<div
					className="student-business-slider position-relative pt-4 bg-transparent flex-xl-shrink-0 zindex-5 start-50 translate-middle-x my-n1"
								...
								{mode !== undefined && mode === "dark" ? (
									<img-comparison-slider className="mx-n5 rounded-1 mx-xl-0 d-dark-mode-block lightmode-dashboard-slider">
										<Image
											className=""
											slot="first"
											src="/assets/img/landing/saas-2/STUDENT DASHBOARD DARK MODE.JPG"
											height={1000}
											width={2000}
											alt="Dark Mode"
										/>
										<Image
											className=""
											slot="second"
											src="/assets/img/landing/saas-2/BUSINESS DASHBOARD DARK MODE.JPG"
											height={1000}
											width={2000}
											alt="Dark Mode"
										/>
									...
									<img-comparison-slider className="mx-n5 rounded-1 mx-xl-0 d-dark-mode-none darkmode-dashboard-slider">
										<Image
											slot="first"
											src="/assets/img/landing/saas-2/STUDENT DASHBOARD LIGHT MODE.JPG"
											width={1000}
											height={2000}
											alt="Light Mode"
										/>
										<Image
											slot="second"
											src="/assets/img/landing/saas-2/BUSINESS DASHBOARD LIGHT MODE.JPG"
											width={1000}
											height={2000}
											alt="Light Mode"
										/>
				...
				<div
					className="position-absolute top-0 start-0 w-50  h-100 d-none d-dark-mode-block"
					style={{ backgroundColor: "#171a1e" }}
				></div>
				<div
					className="position-absolute top-0 end-0 w-50 h-100 d-dark-mode-none"
				...
				></div>
				<div
					className="position-absolute top-0 end-0 w-50 h-100 d-none d-dark-mode-block"
					style={{ backgroundColor: "#171a1e" }}
				></div>
			</section>

			<section
				className="row align-items-center mx-auto w-100 px-3 py-4 overflow-hidden"
				style={{ maxWidth: "1180px" }}
			>
				<div
					className="row align-items-center mx-auto py-4 py-lg-5 my-sm-2 my-md-4 my-lg-0 my-xl-2 my-xxl-4"
					data-aos="fade-up"
				...
				>
					<div className="col-md-6 pt-xl-2 pb-3 pb-3 pb-md-0 mb-3 mb-sm-4 mb-md-0">
						<Image
							className="d-dark-mode-none row justify-content-center align-content-center ms-lg-4 ms-md-3"
							src="/assets/img/landing/saas-1/features/03-light.png"
							width={436}
							height={100}
							alt="Image"
						/>
						<Image
							className="d-none d-dark-mode-block"
							src="/assets/img/landing/saas-1/features/03-dark.png"
							width={436}
							height={100}
							alt="Image"
						/>
					...
					<div
						className="col-md-6 col-xl-5 offset-xl-1 pt-xl-2"
						data-aos="fade-up"
					...
					>
						<div className="pe-md-3 pe-xl-2">
							<span className="badge bg-faded-primary text-primary fs-sm mb-3 mb-lg-4">
								For Business
							</span>
							<h3 className="h2 mb-lg-4">
								{" "}
								A platform designed to meet your needs{" "}
							</h3>
							<ul className="list-unstyled mb-0">
								<li className="d-flex pt-1 mt-2">
									<i className="ai-check-alt text-primary fs-4 mt-n1 me-2"></i>{" "}
				...
				<div
					className="row align-items-center justify-content-center ms-lg-5 mx-auto py-4 py-lg-5 my-sm-2 my-md-4 my-lg-0 my-xl-2 my-xxl-4"
					data-aos="fade-up"
					data-aos-duration="600"
					data-aos-offset="300"
					data-disable-parallax-down="md"
				>
					<div className="col-md-6 offset-xl-1 order-md-2 pb-3 pb-md-0 mb-3 mb-sm-4 mb-md-0 ms-aut">
						<Image
							className="d-dark-mode-none"
							src="/assets/img/landing/saas-1/features/04-light.png"
							width="336"
							height="100"
							alt="Image"
						/>
						<Image
							className="d-none d-dark-mode-block"
							src="/assets/img/landing/saas-1/features/04-dark.png"
							width="336"
							height="100"
							alt="Image"
						/>
			...
			<section className="container mt-5">
				<div className="bg-dark rounded-5 position-relative overflow-hidden py-5 px-4 px-sm-5">
					...
					<div className="dark-mode position-relative zindex-3 text-center px-3 px-sm-0 pb-2 py-sm-3 py-md-4 py-lg-5">
						<h2 className="display-3 pt-xl-2">
							Get Started with <span className="text-primary">Uniskills</span>
						</h2>
						...
						<div
							className="position-relative text-center zindex-2 ms-auto me-auto"
							data-aos="fade-up"
							data-aos-duration="500"
							data-aos-offset="280"
							data-disable-parallax-down="lg"
							...
							<div className="card-body pb-lg-5  ps-lg-5">
								...
								<div className="row row-cols-1 ms-auto me-auto row-cols-sm-2">
									<ul className="col list-unstyled ms-auto me-auto pb-1 pb-sm-0 mb-2 mb-sm-0">
										...
										<li className="d-flex pb-1 mb-2">
											<i className="ai-check text-success fs-lg mt-1 me-2"></i>
											With our 24/7 & 365 days of customer-support and service,
											we`re always here to take the pressure off your shoulders.
										</li>
									</ul>
								</div>
							</div>
						...
						<Link
							className="btn btn-lg btn-primary mb-lg-2 mb-xl-4"
							href={`/${config.LOGIN}`}
						>
							Get Started
						</Link>
