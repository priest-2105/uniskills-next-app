				...
				<div className="offcanvas-body pb-5">
					...
					<form onSubmit={handleSubmit} className="needs-validation row g-4">
						<div className="col-lg-10">
							<label className="form-label fs-base" for="search">
			...
			<section className="pt-3 pb-4 px-lg-3">
				<div className=" py-lg-2 py-xl-4 py-xxl-5">
					<div className="row mt-1 ps-2  pt-sm-2 pt-md-3 pt-lg-4">
						<div
							className={`desktop-filter h-100 bg-secondary rounded pt-3 ps-3 pe-2 pb-3 mb-5 mb-lg-0 ${
						...
						>
							...
							<div className="d-flex align-items-center justify-content-end mb-2">
								<h2 className="w-100 mb-0 fs-6">Filter your Results</h2>
								<button
							...
							>
								...
								<div className="col-lg-10">
									<label className="form-label fs-base" htmlFor="proximity">
										Job Proximity
									</label>
						...
						>
							<div className="row row-cols-12 row-cols-sm-12">
								<div className="col">
									...
									>
										<div className="search-results px-lg-4">
											{/* <a
