 ...
 .nav-pills::-webkit-scrollbar-thumb {
  ...
  `}</style>
      ...
      <div class="profile-top">
        <img src="/assets/img/avatar/02.jpg" alt="" class="student-profile-picture"/>
      <div class="profile-top-info">
        <h2>Jane Doe</h2>
        <p>Product Manager</p>
        <li class=""><i class="bi ms-2 bi-star-fill"></i> <br/> <span>3.1 (1 Review)</span> 
          <i class="bi ms-2 bi-geo-alt-fill"></i><span> Los Angeles </span>  </li>
         </div> 
    ...
    {/* <!-- <a class="btn btn-primary mobile-profile-button btn-sm ms-auto me-2" href="#">Invite</a>
      ...
      <a class="btn btn-primary btn-sm btn-lg-md btn-xl-md  ms-auto me-md-2 me-lg-2 me-xl-2" href="#">Invite <i class="bi ms-1 fs-8 bi-patch-plus"></i></a>
      <a class="btn btn-primary btn-sm ms-auto me-md-5 me-lg-5 me-xl-5" href="#">Save<i class="bi ms-1 fs-8 bi-box-arrow-down"></i> </a> 
   
    </div>


     <div class="job-info">
           <li class=""> <p>Career :</p> <i class="bi ms-2 bi-calendar-date-fill"></i> <span>Project Manager</span>  </li> 
        <li class=""> <p>Location :</p> <i class="bi ms-2 bi-geo-alt-fill"></i><span> Los Angeles </span>   </li>
        <li class=""> <p>Rating :</p> <i class="bi ms-2 bi-star-fill"></i> <span>3.1 (1 Review)</span> </li>
  </div> 
      ...
      <div class="bottom-section">
        ...
        <div class="left-bottom-section">
          <div class="tabs ms-auto mt-3 me-lg-auto ms-lg-4 ms-xl-4 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <ul class="nav-pills mb-3 me-sm-4 me-xs-3" id="pills-tab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link rounded-pill active" id="pills-about-tab" data-bs-toggle="pill" data-bs-target="#pills-about" type="button" role="tab" aria-controls="pills-about" aria-selected="true">  About </button>
            </li>
                <li class="nav-item" role="presentation">
                <button class="nav-link rounded-pill" id="pills-education-tab" data-bs-toggle="pill" data-bs-target="#pills-education" type="button" role="tab" aria-controls="pills-education" aria-selected="false" >Education</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link rounded-pill" id="pills-portfolio-tab" data-bs-toggle="pill" data-bs-target="#pills-portfolio" type="button" role="tab" aria-controls="pills-portfolio" aria-selected="false">Portfolio</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link rounded-pill" id="pills-review-tab" data-bs-toggle="pill" data-bs-target="#pills-review" type="button" role="tab" aria-controls="pills-review" aria-selected="false">Feedback</button>
            </li>
            </ul></div>



            <div class="tab-content mt-5 pt-3 pb-3 ps-lg-4 ps-xl-4 ps-md-4 pe-md-4 pe-lg-4 pe-xl-4 " id="pills-tabContent">
 

              <div class="tab-pane fade active show" id="pills-about" role="tabpanel" aria-labelledby="pills-about-tab" tabindex="0">
           ...
           {/* <!-- education tab  --> */}
              <div class="tab-pane fade border-0" id="pills-education" role="tabpanel" aria-labelledby="pills-education-tab" tabindex="0"> 
           ...
           {/* <!-- portfolio tab  --> */}
              ...
              <div class="tab-pane fade" id="pills-portfolio" role="tabpanel" aria-labelledby="pills-portfolio-tab" tabindex="0">
           

                <div class="border-0 portfolio-card shadow-sm my-class-card card pb-3 bg-secondary pe-2"> 
                  {/* <!-- Button trigger modal --> */}
             
             <div id="carouselExampleIndicatorssoftware" class="carousel slide">
              <div class="carousel-indicators">
                <button type="button" data-bs-target="#carouselExampleIndicatorssoftware" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                <button type="button" data-bs-target="#carouselExampleIndicatorssoftware" data-bs-slide-to="1" aria-label="Slide 2"></button>
                <button type="button" data-bs-target="#carouselExampleIndicatorssoftware" data-bs-slide-to="2" aria-label="Slide 3"></button>
              </div>
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="/assets/img/business-details/code.jpg" class="d-block w-100" alt="..."/>
                </div>
                <div class="carousel-item">
                  <img src="/assets/img/business-details/code (2).jpg" class="d-block w-100" alt="..."/>
                </div>
                <div class="carousel-item">
                  <img src="/assets/img/business-details/xode.jpg" class="d-block w-100" alt="..."/>
                </div>
              </div>
              <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicatorssoftware" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
              </button>
              <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicatorssoftware" data-bs-slide="next">
              ...
              <div  class="skills-list pt-4 ps-1">
                             <a href="#" class="rounded-pill btn btn-sm">HTML</a>
                             <a href="#" class="rounded-pill btn btn-sm">CSS</a>
                             <a href="#" class="rounded-pill btn btn-sm">UI/UX</a>
                             <a href="#" class="rounded-pill btn btn-sm">Graphic Desiging</a>
             ...
             <span>11/03/2022</span> 
                 ...
                 <div class="border-0 portfolio-card shadow-sm my-class-card card pb-3 bg-secondary pe-2"> 
                  <div id="carouselExampleIndicatorscraft" class="carousel slide">
                    <div class="carousel-indicators">
                      <button type="button" data-bs-target="#carouselExampleIndicatorscraft" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                      <button type="button" data-bs-target="#carouselExampleIndicatorscraft" data-bs-slide-to="1" aria-label="Slide 2"></button>
                      <button type="button" data-bs-target="#carouselExampleIndicatorscraft" data-bs-slide-to="2" aria-label="Slide 3"></button>
                    </div>
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="/assets/img/business-details/clothes (2).jpg" class="d-block w-100" alt="..."/>
                      </div>
                      <div class="carousel-item">
                        <img src="/assets/img/business-details/clothes (3).jpg" class="d-block w-100" alt="..."/>
                      </div>
                      <div class="carousel-item">
                        <img src="/assets/img/business-details/clothes.jpg" class="d-block w-100" alt="..."/>
                      </div>
                    </div>
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicatorscraft" data-bs-slide="prev">
                      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                      <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicatorscraft" data-bs-slide="next">
                      <span class="carousel-control-next-icon" aria-hidden="true"></span>
                      <span class="visually-hidden">Next</span>
                    </button>
                  </div>     
      ...
      <div class="right-bottom-section">
        ...
        <div class="top-submit-proposal"  id="scroll-student-rate">
          <a href="#" class="btn ms-auto me-auto btn-primary">Message <i class="bi ms-2 fs-5 bi-send-fill"></i></a>
        </div>
           ...
           <div class="video-cv-card-container bg-secondary rounded mb-5 bg-secondary pt-2 ps-1 pe-1 pb-4" id="scroll-video-cv">
            <div class="video-cv-card pb-4">
              <h5 class="ms-2 mt-1">Video CV</h5>
              <iframe width="100%" height="400"  src="https://www.youtube.com/embed/c_PZTAW5piQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div> 
          </div>
