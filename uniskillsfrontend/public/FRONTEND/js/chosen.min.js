...
(function () {
  ...
  (d = (function () {
    ...
    (d.select_to_array = function (a) {
      var b, c, e, f, g;
      for (c = new d(), g = a.childNodes, e = 0, f = g.length; e < f; e++)
        (b = g[e]), c.add_node(b);
      return c.parsed;
    }),
    (b = (function () {
      ...
      return (
        ...
        (a.prototype.reset_single_select_options = function () {
          var a, b, c, d, e;
          for (d = this.results_data, e = [], b = 0, c = d.length; b < c; b++)
        ...
        (a.prototype.choices_click = function (a) {
          if ((a.preventDefault(), !this.results_showing && !this.is_disabled))
    ...
    (c = (function (b) {
      ...
      return (
        ...
        (c.prototype.container_mouseup = function (a) {
          if ("ABBR" === a.target.nodeName && !this.is_disabled)
        ...
        (c.prototype.choice_destroy_link_click = function (b) {
          if ((b.preventDefault(), b.stopPropagation(), !this.is_disabled))
            return this.choice_destroy(a(b.target));
        }),
        (c.prototype.choice_destroy = function (a) {
          if (
            this.result_deselect(a[0].getAttribute("data-option-array-index"))
          )
            return (
              this.show_search_field_default(),
              this.is_multiple &&
