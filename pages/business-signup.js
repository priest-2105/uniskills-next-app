...
export default function BusinessSignup() {
  ...
  const page_initials = { page_title: "Business Sign Up | "+config.APP_NAME };
                ...
                <div className="d-flex flex-column align-items-center w-lg-50 h-100 px-3 px-lg-5 pt-5 pb-5 mt-4">
                    <div className="w-100 mt-auto" style={{ "maxWidth": "526px" }}>
                        ...
                        <p className="pb-3 mb-3 mb-lg-4">
                            Have an account already?&nbsp;&nbsp;<Link href={config.LOGIN}>Sign in here!</Link>
                        </p>
                        ...
                        <form className="needs-validation" novalidate>
                            ...
                            <div className="col mb-4">
                                <input className="form-control form-control-lg" type="text" placeholder="Company's Name" required />
                            </div>
                            ...
                            <div className="mb-4">
                                ...
                                <div>
                                    <div className="form-check form-check-inline">
                                        <input className="form-check-input" name="interest" type="radio" id="employment" value="Employment opportunities" />
                                        <label className="form-check-label" for="employment">Employment opportunities</label>
                                    </div>
                                    <div className="form-check form-check-inline">
                                        <input className="form-check-input" name="interest" type="radio" id="freelance-jobs" value="Freelance jobs" />
                                        <label className="form-check-label" for="freelance-jobs">Freelance jobs</label>
                                    </div>
                                    <div className="form-check form-check-inline">
                                        <input className="form-check-input" name="interest" type="radio" id="both" value="Both" />
